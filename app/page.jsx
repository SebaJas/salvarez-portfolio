...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <section id="top" className={`pt-28 sm:pt-40 pb-16 sm:pb-24 px-4 sm:px-8 bg-slate-50 transition-all duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
            ...
            <div className="hidden lg:block">
              <div className="bg-slate-900 rounded-xl p-6 shadow-2xl border border-slate-800">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="ml-2 text-slate-500 text-xs font-mono">~</span>
                </div>
                <pre className="text-sm font-mono leading-relaxed overflow-x-auto text-slate-300">
<span className="text-emerald-400">$</span> whoami{'\n'}
<span className="text-slate-400">Sebastian Alvarez</span>{'\n'}
{'\n'}
<span className="text-emerald-400">$</span> cat role.txt{'\n'}
...
Argentina · Remote since <span className="text-amber-400">2019</span>{'\n'}
<span className="text-emerald-400 animate-pulse">▌</span></pre>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className={`py-16 sm:py-24 px-4 sm:px-8 bg-slate-900 text-white transition-all duration-1000 delay-200 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-stretch">
            ...
            <div className="hidden lg:flex flex-col order-1">
              <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700 flex flex-col justify-between flex-1">
                ...
                <div className="space-y-6 flex-1 flex flex-col justify-center">
                  ...
                  <div className="flex items-center justify-center gap-4">
                    <div className="bg-slate-700 px-4 py-3 rounded-lg border border-slate-600 text-center">
                      <p className="text-xs text-slate-400 mb-1">{t.command}</p>
                      <p className="text-sm text-slate-200 font-medium">{t.writeService}</p>
                    </div>
                    <div className="bg-slate-700 px-4 py-3 rounded-lg border border-slate-600 text-center">
                      <p className="text-xs text-slate-400 mb-1">{t.query}</p>
      ...
      <section id="projects" className={`py-16 sm:py-24 px-4 sm:px-8 bg-slate-900 text-white transition-all duration-1000 delay-400 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-[1fr_440px] gap-8 lg:gap-12 items-stretch">
            <div>
            ...
            <div className="hidden lg:flex flex-col">
              <div className="bg-slate-950 rounded-xl border border-slate-800 shadow-xl overflow-hidden flex flex-col flex-1">
                {/* Dashboard Header */}
                <div className="px-5 py-3 border-b border-slate-800 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 rounded-full bg-sky-500 flex items-center justify-center text-[10px] font-bold text-white">V</div>
                    <span className="text-sm font-medium text-slate-200">VinilHub</span>
                    <span className="text-xs text-slate-500">/ Store Dashboard</span>
                  </div>
                  <span className="text-[10px] text-emerald-400 bg-emerald-900/30 px-2 py-0.5 rounded-full border border-emerald-800">Pro Plan</span>
                </div>

                {/* Stats Row */}
                <div className="grid grid-cols-3 border-b border-slate-800">
                  <div className="px-5 py-4 border-r border-slate-800">
                    <p className="text-[10px] text-slate-500 uppercase tracking-wider mb-1">Listings</p>
                    <p className="text-xl font-semibold text-slate-200">248</p>
                  </div>
                  <div className="px-5 py-4 border-r border-slate-800">
                    <p className="text-[10px] text-slate-500 uppercase tracking-wider mb-1">Sales</p>
                    <p className="text-xl font-semibold text-slate-200">1,847</p>
                  </div>
                  <div className="px-5 py-4">
                    <p className="text-[10px] text-slate-500 uppercase tracking-wider mb-1">Revenue</p>
                    <p className="text-xl font-semibold text-emerald-400">$42.3k</p>
                  </div>
                </div>

                {/* Recent Listings */}
                <div className="px-5 py-4 flex-1">
                  <p className="text-[10px] text-slate-500 uppercase tracking-wider mb-3">Recent Listings</p>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded bg-slate-800 border border-slate-700 flex items-center justify-center text-[10px] text-slate-400">LP</div>
                        <div>
                          <p className="text-sm text-slate-200">Abbey Road</p>
                          <p className="text-[11px] text-slate-500">The Beatles · 1969</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="text-sm text-slate-200">$85</p>
                        <p className="text-[10px] text-amber-400">Near Mint</p>
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded bg-slate-800 border border-slate-700 flex items-center justify-center text-[10px] text-slate-400">LP</div>
                        <div>
                          <p className="text-sm text-slate-200">Dark Side of the Moon</p>
                          <p className="text-[11px] text-slate-500">Pink Floyd · 1973</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="text-sm text-slate-200">$120</p>
                        <p className="text-[10px] text-emerald-400">Mint</p>
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded bg-slate-800 border border-slate-700 flex items-center justify-center text-[10px] text-slate-400">LP</div>
                        <div>
                          <p className="text-sm text-slate-200">Rumours</p>
                          <p className="text-[11px] text-slate-500">Fleetwood Mac · 1977</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="text-sm text-slate-200">$65</p>
                        <p className="text-[10px] text-sky-400">VG+</p>
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded bg-slate-800 border border-slate-700 flex items-center justify-center text-[10px] text-slate-400">LP</div>
                        <div>
                          <p className="text-sm text-slate-200">OK Computer</p>
                          <p className="text-[11px] text-slate-500">Radiohead · 1997</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="text-sm text-slate-200">$95</p>
                        <p className="text-[10px] text-amber-400">Near Mint</p>
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded bg-slate-800 border border-slate-700 flex items-center justify-center text-[10px] text-slate-400">LP</div>
                        <div>
                          <p className="text-sm text-slate-200">Kind of Blue</p>
                          <p className="text-[11px] text-slate-500">Miles Davis · 1959</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="text-sm text-slate-200">$150</p>
                        <p className="text-[10px] text-emerald-400">Mint</p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="px-5 py-3 border-t border-slate-800 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] text-slate-500">Discogs catalog synced</span>
                  </div>
                  <span className="text-[10px] text-slate-600">248 of 312 imported</span>
                </div>
              </div>
            </div>
          </div>
