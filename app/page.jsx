...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      {/* Hero */}
      <section className={`pt-40 pb-24 px-6 transition-all duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      {/* Technical Expertise */}
      <section className={`py-24 px-6 transition-all duration-1000 delay-200 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
        <div className="max-w-4xl mx-auto">
          <p className="text-sm text-sky-600 tracking-widest uppercase mb-12 font-medium">Technical Expertise</p>
          
          <div className="grid md:grid-cols-2 gap-x-16 gap-y-10">
            <div>
              <h3 className="text-xs text-slate-400 uppercase tracking-wider mb-3">Languages</h3>
              <p className="text-slate-700">Go (primary), TypeScript, Python, PHP, SQL</p>
            </div>
            <div>
              <h3 className="text-xs text-slate-400 uppercase tracking-wider mb-3">Architecture</h3>
              <p className="text-slate-700">CQRS, DDD, Hexagonal, Microservices, Event-Driven</p>
            </div>
            <div>
              <h3 className="text-xs text-slate-400 uppercase tracking-wider mb-3">Backend</h3>
              <p className="text-slate-700">Fiber, NestJS, Django, Laravel, Node.js</p>
            </div>
            <div>
              <h3 className="text-xs text-slate-400 uppercase tracking-wider mb-3">Databases</h3>
              <p className="text-slate-700">PostgreSQL, MySQL, DynamoDB, Redis, Snowflake</p>
            </div>
            <div>
              <h3 className="text-xs text-slate-400 uppercase tracking-wider mb-3">Cloud & Infrastructure</h3>
              <p className="text-slate-700">AWS (S3, Lambda, IoT Core, EC2, SNS, SQS), Docker, Kubernetes, Kafka</p>
            </div>
            <div>
              <h3 className="text-xs text-slate-400 uppercase tracking-wider mb-3">Frontend</h3>
              <p className="text-slate-700">React, Next.js, Tailwind CSS, Zustand</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Experience */}
      <section id="experience" className={`py-24 px-6 transition-all duration-1000 delay-300 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-16">
            ...
            <div className="grid md:grid-cols-[200px_1fr] gap-4 md:gap-8">
              <div>
                <p className="text-sm text-slate-500">2019 — 2025</p>
      ...
      {/* Featured Project */}
      <section id="projects" className={`py-24 px-6 bg-slate-100/50 transition-all duration-1000 delay-400 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
        <div className="max-w-4xl mx-auto">
          <p className="text-sm text-sky-600 tracking-widest uppercase mb-12 font-medium">Featured Project</p>
          
          <div>
            <h3 className="text-2xl font-medium mb-2">VinilHub</h3>
            <p className="text-slate-500 mb-6">Argentina's first specialized vinyl marketplace</p>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div className="bg-white p-6 rounded-lg border border-slate-200">
                <h4 className="text-xs text-sky-600 uppercase tracking-wider mb-4 font-medium">Architecture</h4>
              ...
              <div className="bg-white p-6 rounded-lg border border-slate-200">
                <h4 className="text-xs text-sky-600 uppercase tracking-wider mb-4 font-medium">Features</h4>
                <ul className="space-y-2 text-slate-600 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="text-sky-500 mt-0.5">→</span>
      ...
      {/* Key Achievements */}
      <section className={`py-24 px-6 transition-all duration-1000 delay-500 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
        <div className="max-w-4xl mx-auto">
      ...
      {/* Education */}
      <section className={`py-24 px-6 transition-all duration-1000 delay-600 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
        <div className="max-w-4xl mx-auto">
          <p className="text-sm text-sky-600 tracking-widest uppercase mb-12 font-medium">Education</p>
          
          <div className="grid md:grid-cols-[200px_1fr] gap-4 md:gap-8">
            <div>
              <p className="text-sm text-slate-500">2008 — 2015</p>
            </div>
            <div>
              <h3 className="text-xl font-medium mb-1">Informatic Systems Engineering</h3>
              <p className="text-sky-700">La Plata Catholic University (UCALP)</p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            <div>
              ...
              <p className="text-sm text-slate-400">Open to opportunities and interesting conversations.</p>
            </div>
            <div className="flex flex-col gap-2 text-sm">
              <a href="mailto:alvarez.sebastian605@gmail.com" className="text-slate-300 hover:text-white transition-colors">
                alvarez.sebastian605@gmail.com
              </a>
              <a href="tel:+5492804206150" className="text-slate-400 hover:text-white transition-colors">
                +54 9 2804206150
              </a>
            </div>
          </div>
          <div className="mt-12 pt-8 border-t border-slate-800 flex flex-col md:flex-row md:items-center md:justify-between gap-4 text-xs text-slate-500">
            <p>© {new Date().getFullYear()} Sebastian Alvarez</p>
            <div className="flex items-center gap-4">
              <a href="https://github.com/SebaJas" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">GitHub</a>
              <a href="https://www.linkedin.com/in/sebaalvarez87/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">LinkedIn</a>
